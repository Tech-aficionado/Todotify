...
@Component({
    ...
    template: ` <div id="features" class="py-6 px-6 lg:px-20 mt-8 mx-0 lg:mx-20">
        <div class="grid grid-cols-12 gap-4 justify-center">
            ...
            <div class="col-span-12 mt-20 mb-20 p-2 md:p-20" style="border-radius: 20px; background:radial-gradient(circle, rgb(64 59 138) 23%, rgb(6 3 37) 100%, rgb(255 255 255) 100%);">
                <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
                    ...
                    <p class="text-gray-100 sm:line-height-2 md:line-height-4 text-2xl mt-6" style="max-width: 800px">
                        “I am Shivansh Goel, a passionate technology aficionado and software developer behind Todotify, your ultimate task management solution. With a deep interest in web development, full-stack engineering, and open-source
                        technologies, I leverage tools like Angular, PrimeNG, Node.js, and MySQL to create intuitive, efficient, and modern applications. My journey in tech began with a curiosity for how software works, leading me to explore
                        frameworks, APIs, and databases to build impactful solutions.”
                    </p>
