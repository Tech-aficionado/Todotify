...
@Component({
            ...
            @media (max-width: 768px) {
                ...
                &.curvy-bottom {
                    clip-path: polygon(
                        ...
                        // Right curve point
                        50% 95%,
                        // Bottom center (inverted semi-circle peak)
                        10% 100%,
                        // Left curve point
                        0 85% // Bottom-left
            ...
            @media (min-width: 769px) {
                ...
                &.curvy-bottom {
                    clip-path: polygon(
                        ...
                        // Top-right
                        100% calc(100% - 120px),
                        // Deeper wave start for ocean effect
                        calc(100% - 100px) calc(100% - 40px),
                        // First wave peak
                        90% calc(100% - 20px),
                        // Second wave peak (gentler)
                        75% calc(100% - 60px),
                        // Wave valley
                        60% calc(100% - 30px),
                        // Third wave peak
    ...
    `,
    template: `
        <div id="hero" class="flex flex-col pt-6 px-6 lg:px-20 overflow-hidden min-h-screen curvy-bottom" style="background: radial-gradient(circle, rgb(100, 97, 146) 23%, rgb(38, 24, 190) 100%, rgba(0, 212, 255, 1) 100%);">
            <div class="mx-auto max-w-7xl w-full">
                <div class="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div class="flex-1 text-left mb-8 md:mb-0">
                        ...
                        <p class="font-normal text-xl md:text-2xl leading-normal mt-4 md:mt-6 text-gray-300">Transform Tasks into Triumphs</p>
                        <div class="button-container mt-8">
                            <p-button *ngIf="!access" routerLink="/auth/login" [rounded]="true" label="Get Started" pRipple icon="pi pi-cloud" />
                    ...
                    <div class="flex-1 flex justify-center md:justify-end">
                        <img src="https://cdni.iconscout.com/illustration/premium/thumb/business-to-do-list-5718709-4780834.png" alt="Hero Image" class="w-full md:w-auto max-w-md" />
                    </div>
                </div>
            </div>
        </div>
