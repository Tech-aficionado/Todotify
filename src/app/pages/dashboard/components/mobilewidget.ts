...
@Component({
    ...
    template: ` <div class="grid">
            ...
            <div class="col-6 mb-3" *ngIf="loading">
                <p-button size="small" styleClass="w-full rounded-2xl" severity="secondary">
                    <ng-template pTemplate>
                        <div style="display: flex; width: 100%; align-items: center;">
                            ...
                            <span class="p-badge" style="flex: 0 0 auto; color:white;background:black;border-radius: 25%;justify-content: flex-end;"
                                ><small class=" m-1 ">{{ TotalTodos }}</small></span
                            >
                        </div>
                    </ng-template>
                </p-button>
            ...
            <div class="col-6 mb-3" *ngIf="loading">
                <p-button size="small" styleClass="w-full rounded-2xl" severity="success">
                    <ng-template pTemplate>
                        <div style="display: flex; width: 100%; align-items: center;">
                            ...
                            <span class="p-badge" style="flex: 0 0 auto;  color:white;background:black;border-radius: 25%;justify-content: flex-end;"
                                ><small class=" m-1 ">{{ CompletedTodos }}</small></span
                            >
                        </div>
                    </ng-template>
                </p-button>
            ...
            <div class="col-6 mb-3" *ngIf="loading">
                <p-button size="small" styleClass="w-full rounded-2xl" severity="warn">
                    <ng-template pTemplate>
                        <div style="display: flex; width: 100%; align-items: center;">
                            ...
                            <span class="p-badge" style="flex: 0 0 auto; color:white;background:black;border-radius: 25%; justify-content: flex-end;"
                                ><small class=" m-1 ">{{ PendingTodos }}</small></span
                            >
                        </div>
                    </ng-template>
                </p-button>
            ...
            <div class="col-6 mb-3" *ngIf="loading">
                <p-button size="small" styleClass="w-full rounded-2xl" severity="danger">
                    <ng-template pTemplate>
                        <div style="display: flex; width: 100%; align-items: center;">
                            ...
                            <span class="p-badge" style="flex: 0 0 auto; color:white;background:black;border-radius: 25%;justify-content: flex-end;"
                                ><small class=" m-1 ">{{ MissedTodos }}</small></span
                            >
                        </div>
                    </ng-template>
                </p-button>
            ...
            <div class="col-12 mb-3" *ngIf="!loading">
                <p-button size="small" styleClass="w-full rounded-2xl" label="Fetching Todo Counts" [loading]="true"> </p-button>
            </div>
        </div>
        <p-toast />`
})
